...
- **Target Version Selector (PC & Android):** Users can now pick and install any release directly from the GUI on both PC (Preset Editor sidebar "Switch / Pick Version...") and Android ("Switch / Pick Version..."). You can easily switch between stable releases, specific beta versions, or enter custom tags with full preset and data safety.
