...
def run_bot(token, prefix, target_channel_id, roll_command, min_kakera, delay_seconds, mudae_prefix,
    ...
    async def handle_dk_power_management(client, channel, tu_content):
        ...
        # If we have stocked $dk, we can always use them
        # The "vote cooldown" message is not about using existing stock
        # No cooldown check needed - having stock means we can activate them
